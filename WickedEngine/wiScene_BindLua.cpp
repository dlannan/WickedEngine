...
FILTER_NONE = 0
FILTER_OPAQUE = bit.lshift(1, 0)
FILTER_TRANSPARENT = bit.lshift(1, 1)
FILTER_WATER = bit.lshift(1, 2)
FILTER_NAVIGATION_MESH = bit.lshift(1, 3)
FILTER_TERRAIN = bit.lshift(1, 4)
FILTER_OBJECT_ALL = bit.bor(FILTER_OPAQUE, bit.bor(FILTER_TRANSPARENT, bit.bor(FILTER_WATER, bit.bor(FILTER_NAVIGATION_MESH, FILTER_TERRAIN) ) ) )
FILTER_COLLIDER = bit.lshift(1, 5)
FILTER_RAGDOLL = bit.lshift(1, 6)
FILTER_ALL = bit.bnot(0)
